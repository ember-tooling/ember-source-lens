...
import { combineRegexPatterns, fixFilename } from './utils.js';
import { Preprocessor } from 'content-tag';
import { getFileCoordinates } from './get-file-coordinates.js';

const fileCache = new Map();
const fileModifiedTimes = new Map();
const invalidTagPatterns = [/^:/ // Don't process named blocks (:block-name)
];
...
export { p, templatePlugin };
//# sourceMappingURL=rewriteHbs.js.map
