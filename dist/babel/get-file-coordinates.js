...
function getFileCoordinates(source, parsedResult, innerCoordinates) {
   ...
   */
  const column = innerCoordinates.line === 1 ? innerCoordinates.column + templateColumn : innerCoordinates.column;
  const endColumn = innerCoordinates.line === 1 ? innerCoordinates.endColumn + templateColumn : innerCoordinates.endColumn;
  return {
    line,
    endLine,
    column,
...
export { getFileCoordinates };
//# sourceMappingURL=get-file-coordinates.js.map
